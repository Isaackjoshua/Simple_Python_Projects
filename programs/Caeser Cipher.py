""" Caeser cipher, By Isaack Joshua, isaackjoshua23@gmail.com
    The ceaser sipher is a shift cipher that uses addition and subtraction
...
while True: # Keep asking untill the user enter e or d.
...
#Encrypted/derypt each symbeol in the message:
for symbol in message:
    if symbol in SYMBOLS:
        ...
        # Add enccrypted/decrypted number's symbol to translated:
...
try:
    ...
    pass #Do nothing if the pyperclip wasn't installed.
